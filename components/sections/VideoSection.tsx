...
/* Config: lidas de variáveis públicas do Next.js (NEXT_PUBLIC_*).
   Caso não estejam definidas, caem nos valores originais para manter
   compatibilidade com o projeto antigo. */
const API_KEY =
  process.env.NEXT_PUBLIC_YOUTUBE_API_KEY ?? 'AIzaSyBMWHaZ036FcFLxOOmLDIkKF2p-2KUWT-4'
const CHANNEL_ID =
  process.env.NEXT_PUBLIC_YOUTUBE_CHANNEL_ID ?? 'UCITORRpgYFysxixfAa623yQ'
const MAX_RESULTS = 9
