...
export const metadata: Metadata = {
  title: { absolute: 'Cirurgia Robótica de Próstata Fortaleza | Dr. Érico Diógenes' },
  description: 'Cirurgia robótica de próstata em Fortaleza com tecnologia Da Vinci. Dr. Érico Diógenes, referência em prostatectomia robótica no Ceará.',
    ...
    <>
      <section className="py-20 bg-brand-beige">
        <div className="container-site text-center">
          ...
          <h1 className="section-title mt-2">Cirurgia Robótica de Próstata em Fortaleza</h1>
