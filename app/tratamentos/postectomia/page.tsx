...
export const metadata: Metadata = {
  title: { absolute: 'Postectomia (Fimose) Fortaleza | Dr. Érico Diógenes' },
  description: 'Cirurgia de postectomia para fimose em Fortaleza com Dr. Érico Diógenes. Procedimento ambulatorial, seguro e com recuperação rápida.',
