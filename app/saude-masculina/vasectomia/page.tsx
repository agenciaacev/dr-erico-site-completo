...
export const metadata: Metadata = {
  title: { absolute: 'Vasectomia Fortaleza | Dr. Érico Diógenes' },
  description: 'Vasectomia em Fortaleza com Dr. Érico Diógenes: procedimento ambulatorial, rápido e seguro para contracepção masculina definitiva.',
    ...
    <>
      <section className="py-20 bg-brand-beige">
        <div className="container-site text-center">
          ...
          <h1 className="section-title mt-2">Vasectomia em Fortaleza</h1>
