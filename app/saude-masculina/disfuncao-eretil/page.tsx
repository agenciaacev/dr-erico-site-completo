...
export const metadata: Metadata = {
  title: { absolute: 'Disfunção Erétil Fortaleza | Dr. Érico Diógenes' },
  description: 'Tratamento da disfunção erétil em Fortaleza com Dr. Érico Diógenes. Diagnóstico preciso e abordagem individualizada.',
    ...
    <>
      <section className="py-20 bg-brand-beige">
        <div className="container-site text-center">
          ...
          <h1 className="section-title mt-2">Disfunção Erétil em Fortaleza</h1>
