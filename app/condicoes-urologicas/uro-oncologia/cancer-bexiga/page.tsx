...
export const metadata: Metadata = {
  title: { absolute: 'Câncer de Bexiga Fortaleza | Dr. Érico Diógenes' },
  description: 'Diagnóstico e tratamento do câncer de bexiga em Fortaleza. Dr. Érico Diógenes, especialista em uro-oncologia e cirurgia robótica.',
    ...
    <>
      <section className="py-20 bg-brand-beige">
        <div className="container-site text-center">
          ...
          <h1 className="section-title mt-2">Câncer de Bexiga</h1>
