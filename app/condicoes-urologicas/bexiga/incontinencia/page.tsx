...
export const metadata: Metadata = {
  title: { absolute: 'Incontinência Urinária Fortaleza | Dr. Érico Diógenes' },
  description: 'Tratamento de incontinência urinária em Fortaleza com Dr. Érico Diógenes. Perda involuntária de urina tem solução.',
    ...
    <>
      <section className="py-20 bg-brand-beige">
        <div className="container-site text-center">
          ...
          <h1 className="section-title mt-2">Incontinência Urinária</h1>
